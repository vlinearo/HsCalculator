...
/* package PCalculator-0.1.0.0 */
#ifndef VERSION_PCalculator
#define VERSION_PCalculator "0.1.0.0"
#endif /* VERSION_PCalculator */
#ifndef MIN_VERSION_PCalculator
#define MIN_VERSION_PCalculator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_PCalculator */
...
#define CURRENT_COMPONENT_ID "PCalculator-0.1.0.0-inplace-PCalculator"
